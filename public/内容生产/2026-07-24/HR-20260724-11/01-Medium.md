# Before the Bank of England Decision, Fix the Dollar Risk Before You Guess the Direction

The day before a central-bank decision produces an endless supply of forecasts.

GBP/USD could rise, fall, spike in both directions or barely move. None of those scenarios can be known from a position-size formula.
...
For a USD-denominated account trading GBP/USD, one standard lot is approximately $10 per pip.
...
Before the Bank of England decision, the useful checklist is therefore short:
...
For the table above, I checked the arithmetic with PipGauge's [position size calculator](https://pipgauge.com/position-size-calculator/) and [spread cost calculator](https://pipgauge.com/spread-cost-calculator/). They appear here only after the reasoning because a calculator can verify the numbers, not forecast the Bank of England.

The decision may surprise the market. The amount at risk should not surprise the account owner.

## Sources

- [Bank of England: meeting calendar](https://www.bankofengland.co.uk/monetary-policy-summary-and-minutes/2026/july-2026)
- [Reuters Bank of England poll](https://www.streetinsider.com/Reuters/Bank%2Bof%2BEngland%2Bto%2Bhold%2Bsteady%2Bthis%2Byear%2Bbut%2BIran%2Bwar%2Binflation%2Brisks%2Bpersist%3A%2BReuters%2Bpoll/26810803.html)
