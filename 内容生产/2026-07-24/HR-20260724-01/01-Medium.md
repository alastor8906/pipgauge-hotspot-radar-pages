# Before the FOMC Decision, Fix the Dollar Risk Before You Guess the Direction
...
Before the FOMC decision, the useful checklist is therefore short:
...
For the table above, I checked the arithmetic with PipGauge's [position size calculator](https://pipgauge.com/position-size-calculator/) and [spread cost calculator](https://pipgauge.com/spread-cost-calculator/). They appear here only after the reasoning because a calculator can verify the numbers, not forecast the FOMC.
...
- [CBS FOMC preview](https://www.cbsnews.com/news/fed-interest-rate-decision-july-meeting/)
